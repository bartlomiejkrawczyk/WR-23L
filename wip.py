...
class LineFollower:
    ...
    def start(self) -> None:
        self._calibrate = [sensor.reflected_light_intensity for sensor in self._color_sensors]
    ...
    def _read_sensors(self) -> None:
        left_read = self._color_sensors[LEFT].reflected_light_intensity - self._calibrate[LEFT]
        right_read = self._color_sensors[RIGHT].reflected_light_intensity - self._calibrate[RIGHT]
